#!/usr/bin/env python3
"""
Source health monitoring for multi-parser pipeline.
...
HEALTH_FILE = "/tmp/multi-parser-source-health.json"
HISTORY_DAYS = 7
...
def main():
    parser = argparse.ArgumentParser(description="Track source health for multi-parser pipeline.")
